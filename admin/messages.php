...
<div class="container-fluid">
    <div class="row mb-4">
        <div class="col-12">
            ...
            <p class="text-muted">Chat with students and lecturers for support and communication.</p>
        </div>
    </div>
    <div class="row">
        <div class="col-12 col-lg-8 mx-auto">
            <div class="card">
                ...
                <div class="card-body" id="chatBody" style="height: 350px; overflow-y: auto;">
...
const userName = '<?php echo $_SESSION['name'] ?? "Admin"; ?>';
